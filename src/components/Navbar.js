...
export default function Navbar() {
  return (
<header className="bg-myEmerald md:sticky top-0 z-10">
      <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
        ...
        <a
          href="#contact"
          className="inline-flex items-center bg-mySilver bg-opacity-40 border-0 py-1 px-3 focus:outline-none hover:bg-gray-700 rounded text-white mt-4 md:mt-0">
          Contact Me
